...
async function readInteractive(flags) {
...
async function readExplicitProvider(rl, flags, provider) {
    if (provider === "cli") {
        return readCliProvider(rl, flags);
    }
...
async function readCliProvider(rl, flags) {
...
async function readApiProvider(rl, flags) {
...
async function askCliArgs(rl, flags) {
...
function readCliArgsJson(flags) {
